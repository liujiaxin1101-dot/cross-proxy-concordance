...
Script: D:\TC-Sport\motion_computation\scripts\final_report.py
...
### SENSITIVITY: Excluding sub24 (extreme outlier)
  ...
  ------------------------------------------------------------------
  Spearman rho      0.558                 0.562                  +0.004
  rho 95% CI        [0.179,0.793]    [0.173,0.800]
  Cohen's kappa     0.636                 0.618                  -0.018
  Agreement         81.8%                  81.0%
  Conflicts         4/22 (18%)          4/21 (19%)
  ------------------------------------------------------------------

  Delta rho = +0.004: negligible impact
  Delta kappa = -0.018: virtually unchanged
...
### POWER ANALYSIS
  ...
  Current N=22:
    - 50% power to detect rho >= 0.422
    - 80% power to detect rho >= 0.567
...
### CMJ-only vs DJ-only
  ...
  CMJ: N=22
    Spearman rho = 0.546, 95% CI [0.162, 0.787]
    Cohen's kappa = 0.455, 95% CI [0.082, 0.827]
    Agreement = 72.7%, Conflict = 27%
    Conflicts: 3 K+D-, 3 K-D+
    McNemar chi2 = 0.167, p = 0.683

  DJ: N=22
    Spearman rho = 0.300, 95% CI [-0.139, 0.640]
    Cohen's kappa = 0.273, 95% CI [-0.129, 0.675]
    Agreement = 63.6%, Conflict = 36%
    Conflicts: 4 K+D-, 4 K-D+
    McNemar chi2 = 0.125, p = 0.724

### FIGURES

  05_paper_figure.png            -> figures/05_paper_figure.png
                                    Main scatter (PNG, 300 dpi)

  05_paper_figure.pdf            -> figures/05_paper_figure.pdf
                                    Main scatter (PDF, vector, for LaTeX)

  05_main_results.png            -> figures/05_main_results.png
                                    6-panel: scatter, Bland-Altman, confusion, profiles, CMJ-DJ, summary

  sub24_diagnostic.png           -> figures/sub24_diagnostic.png
                                    sub24 time-series diagnostic
...
### QUICK CITATION STRING
  ...
  Spearman rho = 0.56, 95% CI [0.18, 0.79];
  Cohen's kappa = 0.64, 95% CI [0.31, 0.96];
  Agreement = 82%, Conflict = 18%.
